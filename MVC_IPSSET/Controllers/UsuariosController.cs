...
namespace MVC_IPSSET.Controllers
{
    ...
    {
        private readonly MvcIpssetContext _context;

        public UsuariosController(MvcIpssetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcIpssetContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
