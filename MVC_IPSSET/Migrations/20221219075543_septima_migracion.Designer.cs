...
namespace MVCIPSSET.Migrations
{
    ...
    [Migration("20221219075543_septima_migracion")]
            ...
            modelBuilder.Entity("MVC_IPSSET.Models.Movimientos", b =>
                {
                    ...
                    b.HasOne("MVC_IPSSET.Models.Personas", "persona_id")
                        .WithMany("Movimientos")
                        .HasForeignKey("persona_idId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Tipo_id");

                    b.Navigation("persona_id");
                });
